...
- alternative = “less” now produce correct power rates in
  [`pwrss.z.prop()`](https://metinbulus.github.io/pwrss/reference/proportions.oneprop.md)
  function. Thanks to Leszek Gawarecki for reporting the issue.
- The default for p0 argument in
  [`pwrss.chisq.gofit()`](https://metinbulus.github.io/pwrss/reference/proportions.gof.md)
...
- Type 1 and type 2 error plots show and print correct power estimates
  ...
  reporting the issue.
- [`pwrss.z.corr()`](https://metinbulus.github.io/pwrss/reference/correlations.one.md)
...
- Added
  [`pwrss.np.2means()`](https://metinbulus.github.io/pwrss/reference/means.wilcoxon.md),
  [`pwrss.z.logreg()`](https://metinbulus.github.io/pwrss/reference/regression.logistic.md),
  [`pwrss.z.poisreg()`](https://metinbulus.github.io/pwrss/reference/regression.poisson.md),
  [`pwrss.chisq.gofit()`](https://metinbulus.github.io/pwrss/reference/proportions.gof.md),
  and generic
  [`power.chisq.test()`](https://metinbulus.github.io/pwrss/reference/generic.chisq.test.md)
  functions
- Improvements to
  [`plot()`](https://rdrr.io/r/graphics/plot.default.html) function
- Improvements to documentation
- Improvements to
  [`pwrss.z.med()`](https://metinbulus.github.io/pwrss/reference/regression.mediation.md)
  and
  [`pwrss.f.ancova()`](https://metinbulus.github.io/pwrss/reference/ancova.md)
  console print
...
- Added
  [`pwrss.t.reg()`](https://metinbulus.github.io/pwrss/reference/regression.linear.t.md)
  and
  [`pwrss.z.med()`](https://metinbulus.github.io/pwrss/reference/regression.mediation.md)
  functions
